            ...
            <table style={styledTableStyle}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ ...tdStyle, textAlign: 'center', backgroundColor: '#22222270' }}>
                    {formatNumber(lastestData.세력합.collectionVolume)}
                  </td>
                  <td style={{ ...tdStyle, textAlign: 'center', backgroundColor: '#22222270' }}>
                    {formatNumber(lastestData.외국인.collectionVolume)}
                  </td>
                  <td style={{ ...tdStyle, textAlign: 'center', backgroundColor: '#22222270' }}>
                    {formatNumber(lastestData.금융투자.collectionVolume)}
                  </td>
                  ...
                  <td style={{ ...tdStyle, textAlign: 'center', backgroundColor: '#22222270' }}>
                    {formatNumber(lastestData.기타금융.collectionVolume)}
                  </td>
                  <td style={{ ...tdStyle, textAlign: 'center', backgroundColor: '#22222270' }}>{formatNumber(lastestData.은행.collectionVolume)}</td>
                  <td style={{ ...tdStyle, textAlign: 'center', backgroundColor: '#22222270' }}>
                    {formatNumber(lastestData.연기금.collectionVolume)}
                  </td>
                  <td style={{ ...tdStyle, textAlign: 'center', backgroundColor: '#22222270' }}>
                    {formatNumber(lastestData.사모펀드.collectionVolume)}
                  </td>
                  <td style={{ ...tdStyle, textAlign: 'center', backgroundColor: '#22222270' }}>
                    {formatNumber(lastestData.국가매집.collectionVolume)}
                  </td>
                  <td style={{ ...tdStyle, textAlign: 'center', backgroundColor: '#22222270' }}>
                    {formatNumber(lastestData.기타법인.collectionVolume)}
                  </td>
                </tr>
                <tr>
